  ...
  return (
    <div className='py-20' id='projects'>
      <h1 className='heading'>
        {SECTION_HEADINGS.projects.main}{' '}
        <span style={{ color: COLORS.purple }}>
          {SECTION_HEADINGS.projects.highlight}
        </span>
      </h1>
        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          ...
          >
            <PinContainer title={link} href={link}>
              <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden 2xl:h-[30vh] 3xl:h-[25vh] sm:h-[40vh] mb-10'>
              ...
              <div className='flex items-center justify-between mt-7 mb-3'>
                ...
                <div className='flex justify-center items-center'>
                  ...
                  <FaLocationArrow className='ms-3' color={COLORS.purple} />
                </div>
              </div>
            </PinContainer>
          </div>
